              ...
              <div class="single-slide align-center-left animation-style-01 bg-1">
                ...
                <div class="slider-content">
                  ...
                  <div class="default-btn slide-btn">
                    <RouterLink class="links" to="/shop">Shopping Now</RouterLink>
                  </div>
                </div>
              </div>
                    ...
                    <div class="product_desc_info">
                      <div class="product-review">
                        <h5 class="manufacturer">
                          <RouterLink to="/shop">Graphic Corner</RouterLink>
                        </h5>
                ...
                <div class="single-product-wrap">
                  ...
                  <div class="product_desc">
                    <div class="product_desc_info">
                      <div class="product-review">
                        <h5 class="manufacturer">
                          <RouterLink to="/shop">Studio Design</RouterLink>
                        </h5>
                        <div class="rating-box">
                          <ul class="rating">
                            <li><i class="fa fa-star-o"></i></li>
        ...
        <div class="col-lg-12">
          <div class="li-section-title">
            ...
            <ul class="li-sub-category-list">
              <li class="active"><RouterLink to="/shop">Prime Video</RouterLink></li>
              <li><RouterLink to="/shop">Computers</RouterLink></li>
              <li><RouterLink to="/shop">Electronics</RouterLink></li>
            </ul>
          </div>
          <div class="row">
            <div class="product-active owl-carousel">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="li-section-title">
            ...
            <ul class="li-sub-category-list">
              <li class="active"><RouterLink to="/shop">Chamcham</RouterLink></li>
              <li><RouterLink to="/shop">Sanai</RouterLink></li>
              <li><RouterLink to="/shop">Meito</RouterLink></li>
            </ul>
          </div>
          <div class="row">
            <div class="product-active owl-carousel">
        ...
        <div class="col-lg-12">
          ...
          <div class="li-static-home-content">
            ...
            <div class="default-btn">
              <RouterLink to="/shop" class="links">Shopping Now</RouterLink>
            </div>
          </div>
        ...
        <div class="col-lg-12">
          <div class="li-product-tab li-trending-product-tab">
            ...
            <ul class="nav li-product-menu li-trending-product-menu">
              <li>
                <a class="active" data-toggle="tab" href="#home1"><span>Sanai</span></a>
              </li>
              <li>
                <a data-toggle="tab" href="#home2"><span>Camera Accessories</span></a>
              </li>
              <li>
                <a data-toggle="tab" href="#home3"><span>XailStation</span></a>
              </li>
            </ul>
          </div>
          <!-- Begin Li's Tab Menu Content Area -->
